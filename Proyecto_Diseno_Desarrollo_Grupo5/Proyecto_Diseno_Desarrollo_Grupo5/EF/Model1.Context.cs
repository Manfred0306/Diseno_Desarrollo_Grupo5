...
namespace Proyecto_Diseno_Desarrollo_Grupo5.EF
{
    ...
    public partial class DBGRUPO5Entities : DbContext
    {
        ...
        public virtual int SP_USUARIO_PERFIL_ACTUALIZAR1(Nullable<int> iD_USUARIO, string nOMBRE, string cORREO, string cONTRASENA_ACTUAL, string cONTRASENA_NUEVA, ObjectParameter oK, ObjectParameter mSG)
        {
            var iD_USUARIOParameter = iD_USUARIO.HasValue ?
                new ObjectParameter("ID_USUARIO", iD_USUARIO) :
                new ObjectParameter("ID_USUARIO", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_USUARIO_PERFIL_ACTUALIZAR1", iD_USUARIOParameter, nOMBREParameter, cORREOParameter, cONTRASENA_ACTUALParameter, cONTRASENA_NUEVAParameter, oK, mSG);
        }
    
        public virtual ObjectResult<SP_USUARIO_PERFIL_OBTENER1_Result> SP_USUARIO_PERFIL_OBTENER1(Nullable<int> iD_USUARIO)
        {
            var iD_USUARIOParameter = iD_USUARIO.HasValue ?
                new ObjectParameter("ID_USUARIO", iD_USUARIO) :
                new ObjectParameter("ID_USUARIO", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_USUARIO_PERFIL_OBTENER1_Result>("SP_USUARIO_PERFIL_OBTENER1", iD_USUARIOParameter);
        }
    }
}
